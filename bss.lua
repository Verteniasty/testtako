...
getgenv().api = loadstring(game:HttpGet("https://raw.githubusercontent.com/omfgdahoe/Rosemoc/main/api.lua"))()
local bssapi = loadstring(game:HttpGet("https://raw.githubusercontent.com/omfgdahoe/Rosemoc/main/bssapi.lua"))()
